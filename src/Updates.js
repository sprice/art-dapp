      ...
      <div className="pure-g">
        <div className="pure-u-1-1">
          ...
          <div className="info">
            ...
            <p>The beta is live on Rinkeby! Please provide feedback using the chat widget near the bottom right. Our <a href="https://rinkeby.etherscan.io/address/0xd275a265038c9ab985bc96a81aaabcceef8f57b9#code">contract</a> is available for review. We plan to audit this before deplying to mainnet but if you do see any issues please feel free to report them 😃.</p>
